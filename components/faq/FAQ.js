    ...
    <section className="min-h-[60vh] flex justify-center items-center border">
      <div className="container px-6 py-10 mx-auto">
        ...
        <FaqAnswer mainColor={mainColor} title="Nasza Załoga">
          <p className="text-lg">
            Nasi nauczyciele posiadają wykształcenie i doświadczenie w nauczaniu
            i pracy z dziećmi polonijnymi. Szkoła zapewnia wszystkim
            nauczycielom oraz asystentom kursy i szkolenia zawodowe, rozwijające
            umiejętności niezbędne w szkole polonijnej i pracy z dziećmi
            dwujęzycznymi. Kadra pedagogiczna to wizytówka naszej szkoły. Z
            zaangażowaniem, pasją i wielką motywacją nasi nauczyciele
            przygotowują zajęcia, które zainteresują nawet największego
            sceptyka! Oferujemy naukę poprzez gry, zabawy oraz liczne aktywności
            w przyjaznej i stymulującej atmosferze. Dokładamy wszelkich starań,
            aby dzieci czuły się akceptowane, bezpieczne i chętnie uczestniczyły
            w naszych zajęciach. Wasze dziecko będzie uczyło się języka i
            kultury polskiej w sposób kreatywny, poprzez doświadczenia i przy
            użyciu technologii XXI wieku.
          </p>
          <br />
          <Link
