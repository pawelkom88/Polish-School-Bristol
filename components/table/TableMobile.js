...
export default function TableMobile({}) {
  return (
    <>
      <table className="w-full md:hidden border-l text-center text-sm font-light dark:border-neutral-500 mx-auto">
      ...
      <table className="w-full md:hidden border-l text-center text-sm font-light dark:border-neutral-500 mx-auto my-2">
        <thead className="border-t border-r border-b font-medium dark:border-neutral-500">
